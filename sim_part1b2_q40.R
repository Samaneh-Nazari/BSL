###############################################################################
##  sim_part1b2_q40.R — q=40, n in {300, 500}
###############################################################################
...
for (n in ns_main) {
  ...
  results_q40b[[length(results_q40b) + 1]] <- list(q = q, n = n, reps = reps)
  cat(sprintf(" done (%.1fs total)\n",
              as.numeric(difftime(Sys.time(), t0, units = "secs"))))
}
saveRDS(results_q40b, "results_q40b.rds")
cat("Saved results_q40b.rds\n")
